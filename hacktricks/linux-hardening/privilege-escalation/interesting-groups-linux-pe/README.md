...
If you have write permissions over the docker socket read [[../index.html#writable-docker-socket|**this post about how to escalate privileges abusing the docker socket**]]**.**
