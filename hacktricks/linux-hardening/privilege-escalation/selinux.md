...
[[https://www.redhat.com/sysadmin/privileged-flag-container-engines|Introduction and example from the redhat docs]]

[[https://www.redhat.com/en/blog/latest-container-exploit-runc-can-be-blocked-selinux|SELinux]] is a **labeling** **system**. Every **process** and every **file** system object has a **label**. SELinux policies define rules about what a **process label is allowed to do with all of the other labels** on the system.
