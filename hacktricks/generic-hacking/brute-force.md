...
```
```
### [[https://github.com/Mebus/cupp|CUPP]]
...
```
```
### [[https://github.com/cycurity/wister|Wister]]
...
```
```
### [[https://github.com/LandGrey/pydictor|pydictor]]
...
#### [[../pentesting-web/web-tool-wfuzz.md|**WFuzz**]]
...
[[https://github.com/ScorpionesLabs/MSSqlPwner|MSSQLPwner]]
...
```
```
[[https://github.com/carlospolop/hacktricks/blob/master/network-services-pentesting/1521-1522-1529-pentesting-oracle-listener/remote-stealth-pass-brute-force.md#outer-perimeter-remote-stealth-pass-brute-force) (**versions 11.1.0.6, 11.1.0.7, 11.2.0.1, 11.2.0.2,** and **11.2.0.3**|Offline OracleSQL hash bruteforce]]:
...
Some systems have known flaws in the random seed used to generate cryptographic material. This can result in a dramatically reduced keyspace which can be bruteforced with tools such as [[https://github.com/snowdroppe/ssh-keybrute). Pre-generated sets of weak keys are also available such as [g0tmi1k/debian-ssh](https://github.com/g0tmi1k/debian-ssh|snowdroppe/ssh-keybrute]].
...
- [[http://hashtoolkit.com/reverse-hash?) (MD5 & SHA1|~~http://hashtoolkit.com/reverse-hash?~~]]
- [[https://shuck.sh/get-shucking.php) (MSCHAPv2/PPTP-VPN/NetNTLMv1 with/without ESS/SSP and with any challenge's value|https://shuck.sh/get-shucking.php]]
- [[https://www.onlinehashcrack.com) (Hashes, WPA2 captures, and archives MSOffice, ZIP, PDF...|https://www.onlinehashcrack.com/]]
- [[https://crackstation.net) (Hashes|https://crackstation.net/]]
- [[https://md5decrypt.net) (MD5|https://md5decrypt.net/]]
- [[https://gpuhash.me) (Hashes and file hashes|https://gpuhash.me/]]
- [[https://hashes.org/search.php) (Hashes|https://hashes.org/search.php]]
- [[https://www.cmd5.org) (Hashes|https://www.cmd5.org/]]
- [[https://hashkiller.co.uk/Cracker) (MD5, NTLM, SHA1, MySQL5, SHA256, SHA512|https://hashkiller.co.uk/Cracker]]
- [[https://www.md5online.org/md5-decrypt.html) (MD5|https://www.md5online.org/md5-decrypt.html]]
...
Download [[https://github.com/kimci86/bkcrack/releases/tag/v1.4.0|**bkcrack** ]]from the releases page.
...
- [[https://github.com/kaonashi-passwords/Kaonashi/tree/master/wordlists|**Kaonashi**]]
- [[https://github.com/danielmiessler/SecLists/tree/master/Passwords|**Seclists - Passwords**]]

### **Wordlist Generation Tools**

- [[https://github.com/hashcat/kwprocessor|**kwprocessor**]]**:** Advanced keyboard-walk generator with configurable base chars, keymap and routes.
...
**Hashcat** already comes with a **folder containing rules** but you can find [[https://github.com/kaonashi-passwords/Kaonashi/tree/master/rules|**other interesting rules here**]].
