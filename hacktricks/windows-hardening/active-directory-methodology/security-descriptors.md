...
You can give a user access to **execute remotely WMI** [[https://github.com/samratashok/nishang/blob/master/Backdoors/Set-RemoteWMI.ps1|**using this**]]:
...
Give access to **winrm PS console to a user** [[https://github.com/samratashok/nishang/blob/master/Backdoors/Set-RemoteWMI.ps1|**using this**]]**:**
...
Access the **registry** and **dump hashes** creating a **Reg backdoor using** [[https://github.com/HarmJ0y/DAMP|**DAMP**]]**,** so you can at any moment retrieve the **hash of the computer**, the **SAM** and any **cached AD** credential in the computer. So, it's very useful to give this permission to a **regular user against a Domain Controller computer**:
...
```
```
Check [[silver-ticket.md|**Silver Tickets**]] to learn how you could use the hash of the computer account of a Domain Controller.
