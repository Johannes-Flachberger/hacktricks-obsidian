...
The [[https://github.com/ScorpionesLabs/MSSqlPwner|MSSQLPwner]] tool is based on impacket, and allows also authenticate using kerberos tickets, and attack through link chains

![[https://raw.githubusercontent.com/ScorpionesLabs/MSSqlPwner/main/assets/interractive.png|]]
...
The powershell module [[https://github.com/NetSPI/PowerUpSQL|PowerUpSQL]] is very useful in this case.
...
From **Windows** you could also find the links and execute commands manually using a **MSSQL client like** [[https://www.heidisql.com|**HeidiSQL**]]
...
[[https://github.com/CCob/SweetPotato|SweetPotato]] has a collection of these various techniques which can be executed via Beacon's `execute-assembly` command.
