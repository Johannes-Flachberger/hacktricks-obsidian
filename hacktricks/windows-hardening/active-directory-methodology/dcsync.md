...
- one with cleartext passwords from the NTDS for any accounts set with [[https://docs.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/store-passwords-using-reversible-encryption|**reversible encryption**]] enabled. You can get users with reversible encryption with
