...
The specific mechanism can be viewed in section 3.1.5.1 "Authentication Request Behavior" of the [[https://winprotocoldoc.z19.web.core.windows.net/MS-SNTP/%5bMS-SNTP%5d.pdf|official Windows documentation for MS-SNTP protocol]].
